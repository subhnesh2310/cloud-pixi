...
# Build: G30_R6_0_1 | Yang: infinera
#

def create_card(handle, name, required_type, chassis_name, slot_name, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
    :param name: Card identifier.
    :type name: str
...
def get_card(handle, name, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
    :param name: Card identifier.
...
def update_card(handle, name, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
    :param name: Card identifier.
...
def delete_card(handle, name, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
    :param name: Card identifier.
...
def create_tom(handle, card_name, port_name, required_type, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
    :param card_name: Card identifier.
...
def create_flexo_group(handle, name, rate, modulation_format, group_id, carriers, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
    :param name: A generic, configurable name for every facility.
    ...
    :type group_id: int
    :param carriers: A list of carriers that are bound to this facilities. Possible values can be any card/resources/supported-carriers.
    :type carriers: str
...
def create_odu(handle, name, parent_odu, odu_type, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
    :param name: A generic, configurable name for every facility.
...
def create_xcon(handle, name, source, destination, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
    ...
    **Optional Parameters**:
    ...
    source = f"/ioa-ne:ne/ioa-ne:facilities/ioa-ne:odu[ioa-ne:name='{source}']"
    destination = f"/ioa-ne:ne/ioa-ne:facilities/ioa-ne:odu[ioa-ne:name='{destination}']"
...
def create_mc(handle, name, parent_oms, lower_frequency, upper_frequency, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
    :param name: A generic, configurable name for every facility.
...
def create_nmc(handle, name, parent_facility, center_frequency, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
    :param name: A generic, configurable name for every facility.
...
def create_oxcon(handle, name, source, destination, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
    ...
    **Optional Parameters**:
        ...
        :target_output_power_src: str - The source interface target power.
        :target_output_power_dst: str - The destination interface target power.
        :label: str - User label.
    """
    ...
    source = f"/ioa-ne:ne/ioa-ne:facilities/ioa-ne:nmc[ioa-ne:name='{source}']"
    destination = f"/ioa-ne:ne/ioa-ne:facilities/ioa-ne:nmc[ioa-ne:name='{destination}']"
...
def update_amplifier(handle, name, **kwargs):
    ...
    **Optional Parameters**:
        ...
        :span_loss_control: str - Span Loss Control configuration.
...
def create_degree(handle, degree_number, supported_card, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
    ...
    **Optional Parameters**:
    ...
    supported_card = f"/ioa-ne:ne/ioa-ne:equipment/ioa-ne:card[ioa-ne:name='{supported_card}']"
...
def create_adg(handle, adg_number, supported_card, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
...
def create_aaa_server(handle, server_name, server_priority, protocol_supported, server_address, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
...
def create_acl(handle, name, type, interface, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
...
def create_dial_out_server(handle, name, address, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
...
def create_ntp_key(handle, key_id, key_type, key_value, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
...
def create_user(handle, user_name, password, **kwargs):
    """
    :param handle: gxctrl connection handle
    :type handle: str
...
def update_security_policy(handle, **kwargs):
    ...
    **Optional Parameters**:
        ...
        :supported_tls_version: str - Transport Layer Security (TLS) supported version(s).
