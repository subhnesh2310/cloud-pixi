...
# Build: G40_R7_0_0 | Yang: infinera
#
...
def update_super_channel_group(handle, name, **kwargs):
    ...
    **Optional Parameters**:
        ...
        :openwave_contention_check: bool - Enables DNA assisted contention control mechanism in openwave mode.     Only of relevance for line system mode openwave
        :label: str - User label.
        :admin_state: str - The administrative state of the managed object.
